...
(FUNCTION  printInt  [(int r)]
  ...
  (BB 19
    (OPER 85 Func_Exit []  [])
    (OPER 86 Return []  [(m RetReg)])
  )
  (BB 7
    (OPER 21 Mov [(r 16)]  [(i 1000)])
    (OPER 22 Div_I [(r 15)]  [(r 1)(r 16)])
    (OPER 23 Mov [(r 2)]  [(r 15)])
    (OPER 24 Pass []  [(r 2)] [(PARAM_NUM 0)])
    (OPER 25 JSR []  [(s putDigit)] [(numParams 1)])
    (OPER 26 Mov [(r 17)]  [(m RetReg)])
    (OPER 27 Mov [(r 20)]  [(i 1000)])
    (OPER 28 Mul_I [(r 19)]  [(r 2)(r 20)])
    (OPER 29 Sub_I [(r 18)]  [(r 19)(r 1)])
    (OPER 30 Mov [(r 1)]  [(r 18)])
    (OPER 31 Mov [(r 21)]  [(i 1)])
    (OPER 32 Mov [(r 3)]  [(r 21)])
  )
  (BB 8
    (OPER 33 Mov [(r 23)]  [(i 100)])
    (OPER 34 GTE [(r 22)]  [(r 1)(r 23)])
    (OPER 35 BEQ [(r 24)]  [(r 22)(i 0)(bb 11)])
    (OPER 36 Jmp []  [(bb 9)])
  )
  (BB 9
    (OPER 37 Mov [(r 26)]  [(i 100)])
    (OPER 38 Div_I [(r 25)]  [(r 1)(r 26)])
    (OPER 39 Mov [(r 2)]  [(r 25)])
    (OPER 40 Pass []  [(r 2)] [(PARAM_NUM 0)])
    (OPER 41 JSR []  [(s putDigit)] [(numParams 1)])
    (OPER 42 Mov [(r 27)]  [(m RetReg)])
    (OPER 43 Mov [(r 30)]  [(i 100)])
    (OPER 44 Mul_I [(r 29)]  [(r 2)(r 30)])
    (OPER 45 Sub_I [(r 28)]  [(r 29)(r 1)])
    (OPER 46 Mov [(r 1)]  [(r 28)])
    (OPER 47 Mov [(r 31)]  [(i 1)])
    (OPER 48 Mov [(r 3)]  [(r 31)])
  )
  (BB 10
    (OPER 58 Mov [(r 38)]  [(i 10)])
    (OPER 59 GTE [(r 37)]  [(r 1)(r 38)])
    (OPER 60 BEQ [(r 39)]  [(r 37)(i 0)(bb 16)])
    (OPER 61 Jmp []  [(bb 14)])
  )
  (BB 12
    (OPER 53 Mov [(r 35)]  [(i 0)])
    (OPER 54 Pass []  [(r 35)] [(PARAM_NUM 0)])
    (OPER 55 JSR []  [(s putDigit)] [(numParams 1)])
    (OPER 56 Mov [(r 36)]  [(m RetReg)])
  )
  (BB 13
    (OPER 57 Jmp []  [(bb 10)])
  )
  (BB 11
    (OPER 49 Mov [(r 33)]  [(i 1)])
    (OPER 50 EQ [(r 32)]  [(r 3)(r 33)])
    (OPER 51 BEQ [(r 34)]  [(r 32)(i 0)(bb 13)])
    (OPER 52 Jmp []  [(bb 12)])
  )
  (BB 14
    (OPER 62 Mov [(r 41)]  [(i 10)])
    (OPER 63 Div_I [(r 40)]  [(r 1)(r 41)])
    (OPER 64 Mov [(r 2)]  [(r 40)])
    (OPER 65 Pass []  [(r 2)] [(PARAM_NUM 0)])
    (OPER 66 JSR []  [(s putDigit)] [(numParams 1)])
    (OPER 67 Mov [(r 42)]  [(m RetReg)])
    (OPER 68 Mov [(r 45)]  [(i 10)])
    (OPER 69 Mul_I [(r 44)]  [(r 2)(r 45)])
    (OPER 70 Sub_I [(r 43)]  [(r 44)(r 1)])
    (OPER 71 Mov [(r 1)]  [(r 43)])
  )
  (BB 15
    (OPER 81 Pass []  [(r 1)] [(PARAM_NUM 0)])
    (OPER 82 JSR []  [(s putDigit)] [(numParams 1)])
    (OPER 83 Mov [(r 51)]  [(m RetReg)])
    (OPER 84 Jmp []  [(bb 5)])
  )
  (BB 17
    (OPER 76 Mov [(r 49)]  [(i 0)])
    (OPER 77 Pass []  [(r 49)] [(PARAM_NUM 0)])
  ...
  (BB 16
    (OPER 72 Mov [(r 47)]  [(i 1)])
    (OPER 73 EQ [(r 46)]  [(r 3)(r 47)])
    (OPER 74 BEQ [(r 48)]  [(r 46)(i 0)(bb 18)])
    (OPER 75 Jmp []  [(bb 17)])
  )
  (BB 6
...
(FUNCTION  main  []
  ...
  (BB 12
    (OPER 136 Mov [(r 82)]  [(i 10)])
    (OPER 137 EQ [(r 81)]  [(r 5)(r 82)])
    (OPER 138 BEQ [(r 83)]  [(r 81)(i 0)(bb 25)])
  )
  (BB 23
    (OPER 139 Mov [(r 84)]  [(i 99)])
    (OPER 140 Pass []  [(r 84)] [(PARAM_NUM 0)])
    (OPER 141 JSR []  [(s putchar)] [(numParams 1)])
    (OPER 142 Mov [(r 85)]  [(m RetReg)])
    (OPER 143 Mov [(r 86)]  [(i 0)])
    (OPER 144 Pass []  [(r 86)] [(PARAM_NUM 0)])
    (OPER 145 JSR []  [(s putDigit)] [(numParams 1)])
    (OPER 146 Mov [(r 87)]  [(m RetReg)])
    (OPER 147 Mov [(r 88)]  [(i 0)])
    (OPER 148 Pass []  [(r 88)] [(PARAM_NUM 0)])
    (OPER 149 JSR []  [(s putDigit)] [(numParams 1)])
    (OPER 150 Mov [(r 89)]  [(m RetReg)])
    (OPER 151 Mov [(r 90)]  [(i 108)])
    (OPER 152 Pass []  [(r 90)] [(PARAM_NUM 0)])
    (OPER 153 JSR []  [(s putchar)] [(numParams 1)])
    (OPER 154 Mov [(r 91)]  [(m RetReg)])
  )
  (BB 24
    (OPER 175 Mov [(r 101)]  [(i 10)])
    (OPER 176 Pass []  [(r 101)] [(PARAM_NUM 0)])
    (OPER 177 JSR []  [(s putchar)] [(numParams 1)])
    (OPER 178 Mov [(r 102)]  [(m RetReg)])
    (OPER 179 Mov [(r 103)]  [(i 0)])
    (OPER 180 Mov [(m RetReg)]  [(r 103)])
  )
  (BB 26
    (OPER 181 Func_Exit []  [])
    (OPER 182 Return []  [(m RetReg)])
  )
  (BB 6
  ...
  (BB 17
    (OPER 120 Mov [(r 74)]  [(i 2)])
    (OPER 121 Mov [(r 5)]  [(r 74)])
  )
  (BB 18
    (OPER 132 Jmp []  [(bb 15)])
  )
  (BB 20
    (OPER 126 Mov [(r 78)]  [(i 10)])
    (OPER 127 Mov [(r 5)]  [(r 78)])
  )
  (BB 21
    (OPER 131 Jmp []  [(bb 18)])
  )
  (BB 22
    (OPER 128 Mov [(r 79)]  [(i 3)])
    (OPER 129 Mov [(r 5)]  [(r 79)])
    (OPER 130 Jmp []  [(bb 21)])
  )
  (BB 19
    (OPER 122 Mov [(r 76)]  [(i 0)])
    (OPER 123 EQ [(r 75)]  [(r 4)(r 76)])
    (OPER 124 BEQ [(r 77)]  [(r 75)(i 0)(bb 22)])
    (OPER 125 Jmp []  [(bb 20)])
  )
  (BB 16
  ...
  (BB 13
    (OPER 133 Mov [(r 80)]  [(i 0)])
    (OPER 134 Mov [(r 5)]  [(r 80)])
    (OPER 135 Jmp []  [(bb 12)])
  )
  (BB 25
    (OPER 155 Mov [(r 92)]  [(i 98)])
    (OPER 156 Pass []  [(r 92)] [(PARAM_NUM 0)])
    (OPER 157 JSR []  [(s putchar)] [(numParams 1)])
    (OPER 158 Mov [(r 93)]  [(m RetReg)])
    (OPER 159 Mov [(r 94)]  [(i 97)])
    (OPER 160 Pass []  [(r 94)] [(PARAM_NUM 0)])
    (OPER 161 JSR []  [(s putchar)] [(numParams 1)])
    (OPER 162 Mov [(r 95)]  [(m RetReg)])
    (OPER 163 Mov [(r 96)]  [(i 100)])
    (OPER 164 Pass []  [(r 96)] [(PARAM_NUM 0)])
    (OPER 165 JSR []  [(s putchar)] [(numParams 1)])
    (OPER 166 Mov [(r 97)]  [(m RetReg)])
    (OPER 167 Mov [(r 98)]  [(i 61)])
    (OPER 168 Pass []  [(r 98)] [(PARAM_NUM 0)])
    (OPER 169 JSR []  [(s putchar)] [(numParams 1)])
    (OPER 170 Mov [(r 99)]  [(m RetReg)])
    (OPER 171 Pass []  [(r 5)] [(PARAM_NUM 0)])
    (OPER 172 JSR []  [(s printInt)] [(numParams 1)])
    (OPER 173 Mov [(r 100)]  [(m RetReg)])
    (OPER 174 Jmp []  [(bb 24)])
  )
)
